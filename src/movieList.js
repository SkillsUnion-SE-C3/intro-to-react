const movies = [
  {
    ...
    storyline: "Vitalina Varela, a 55-year-old woman from Cape Verde, arrives in Lisbon three days after her husband's funeral. She's been waiting for her plane ticket for more than 25 years."
  },
  {
    name: 'Ad Astra',
    year: 2019,
  ...
  },
  {
    ...
    actors: [
      ...
      'Khadijha Red Thunder', 'Dylan Arnold',
      'Shane Paul McGhie', 'Samuel Larsen',
      'Inanna Sarkis', 'Selma Blair',
      'Pia Mia', 'Swen Temmel',
      'Meadow Williams', 'Peter Gallagher',
      'Jennifer Beals', 'Michael Hull',
      'Sarah Jorge León', 'Chris Kontopidis',
      'Rebecca Lee Robertson', 'ShannonMayers',
      'ByronWigfall', 'JohnEvanko',
      'Mark Axelowitz', 'Paul Fox'
    ],
  ...
  },
  {
    ...
    actors: [
      ...
      'Navid Negahban', 'Nasim Pedrad',
      'Billy Magnussen', 'Jordan A. Nash',
      'Taliyah Blair', 'Aubrey Lin',
      'Amir Boutrous', 'Numan Acar',
      'Omari Bernard', 'Nathaniel Ellul',
      'Sebastien Torkia'
    ],
  ...
  },
  {
    ...
    actors: [
      ...
      'Brie Larson', 'Karen Gillan',
      'Danai Gurira', 'Benedict Wong',
      'Jon Favreau', 'Bradley Cooper',
      'Gwyneth Paltrow', 'Josh Brolin'
    ],
  ...
  },
  {
    ...
    storyline: "Brixton Lorr is a cybernetically enhanced soldier who possesses superhuman strength, a brilliant mind and a lethal pathogen that could wipe out half of the world's population. It's now up to hulking lawman Luke Hobbs and lawless operative Deckard Shaw to put aside their past differences and work together to prevent the seemingly indestructible Lorr from destroying humanity."
  },
  {
    name: 'First cow',
    year: 2019,
  ...
  },
  {
    ...
    storyline: "The new story follows the heroic efforts of the crypto-zoological agency Monarch as its members face off against a battery of god sized monsters, including the mighty Godzilla, who collides with Mothra, Rodan, and his ultimate nemesis, the three headed King Ghidorah. When these ancient superspecies, thought to be mere myths, rise again, they all vie for supremacy, leaving humanity's very existence hanging in the balance."
  },
  {
    name: 'Hellboy',
    year: 2019,
  ...
  },
  {
    ...
    storyline: 'Inspired by the viral New York Magazine article, Hustlers follows a crew of savvy former strip club employees who band together to turn the tables on their Wall Street clients.'
  },
  {
  ...
  },
  {
    ...
    storyline: 'Maleficent and her goddaughter Aurora begin to question the complex family ties that bind them as they are pulled in different directions by impending nuptials, unexpected allies, and dark new forces at play.'
  },
  {
    name: 'Martin Eden',
    year: 2019,
  ...
  },
  {
    ...
    storyline: "After an eye-opening encounter of the third kind, the secret MiB organisation's newest recruit, Agent M, finds herself under the wing of the heroic Agent H in cosmopolitan London, when a shape-shifting duo of intergalactic assassins executes an alien aristocrat. Now, with a devastating super-weapon of mass destruction hidden somewhere on Earth, the Men in Black will leave no stone unturned to retrieve it; however, heavy clouds of mistrust and a scent of betrayal envelop the once-incorruptible agency. Is there a well-placed mole in their midst?"
  },
  {
    name: 'Pacarrete',
    year: 2019,
  ...
  },
  {
    ...
    storyline: 'A newly fostered young boy in search of his mother instead finds unexpected super powers and soon gains a powerful enemy.'
  },
  {
  ...
  },
  {
    ...
    storyline: "Ignoring the eerie warning of a troubled mother suspected of child endangerment, a social worker and her own small kids are soon drawn into a frightening supernatural realm. Their only hope to survive La Llorona's deadly wrath may be a disillusioned priest and the mysticism he practices to keep evil at bay, on the fringes where fear and faith collide."
  },
  {
    name: 'The Lion King',
    year: 2019,
  ...
  },
  {
    ...
    storyline: ' Continuing the story of Max and his pet friends, following their secret lives after their owners leave them for work or school each day.'
  },
  {
    ...
    storyline: 'One night in New Mexico, in the late e 1950s, a switchboard operator and radio DJ discover a strange audio frequency which could change the future forever.'
  },
  {
    name: 'Toy Story 4',
    year: 2019,
  ...
  },
  {
    ...
    writer: ['Jordan Peele'],
    actors: [
      "Lupita Nyong'o", 'Madison Curry',
      'Ashley McKoy', 'Winston Duke',
      'Shahadi Wright Joseph', 'Evan Alex',
      'Elisabeth Moss', 'Tim Heidecker',
      'Yahya Adbul-Mateen II', 'Anna Diop',
      'Cali Sheldon', 'Noelle Sheldon',
      'Napiera Groves', 'Duke Nicholson',
      'Kara Hayward', 'Nathan Harrington',
      'Dustin Ybarra', 'Alan Frazier',
      'Lon Gowan', 'Jordan Peele'
    ],
  ...
  },
  {
    ...
    storyline: 'A Cape Verdean woman navigates her way through Lisbon, following the scanty physical traces her deceased husband left behind and discovering his secret, illicit life.'
  }
]
